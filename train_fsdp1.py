...
from utils import format_metrics_to_gb, print_model_info, seed_all, load_fsdp_model, save_fsdp_model
...
def train_one_epoch(model, loader, optimizer, epoch, rank, args):
    ...
    if args.profile:
        ...
        profiler = torch_npu.profiler.profile(
            ...
            on_trace_ready=torch_npu.profiler.tensorboard_trace_handler("profile/llama_7b_fsdp1_base")
        )
        profiler.start()
